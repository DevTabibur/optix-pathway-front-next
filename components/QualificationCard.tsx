...
export function QualificationCard({ icon: Icon, title, description, delay = 0 }: QualificationCardProps) {
  return (
    <motion.div
    ...
    >
      {/* Icon */}
      <div className="mb-5">
        <div className="w-12 h-12 rounded-xl bg-[#EEF5F9] flex items-center justify-center">
