...
const suitableFor = [
  'Students interested in law, justice, and legal systems',
  'Applicants planning academic or policy-focused careers',
  'Graduates seeking a foundation in legal studies',
  'International students exploring UK legal education'
];
...
const eligibilityInfo = [
  ...
  'Academic performance and writing skills important',
  'Professional outcomes depend on further training'
];

export function LawLegalStudiesSection() {
  return (
    <section id="law-legal-studies" className="bg-white py-24">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-base text-[#475569] leading-[1.7] max-w-[760px] mt-4">
              Law and legal studies courses in the UK focus on legal principles, systems, and critical thinking. These programmes are academic in nature and form the foundation for various career pathways, including further professional training.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-10">
            ...
            <div className="lg:col-span-7 space-y-10">
              ...
              {/* Professional Qualification Note */}
              <div>
                <h3 className="text-lg font-semibold text-[#0F172A] mb-4">
                  Professional Qualification Note
                </h3>
                <p className="text-[15px] leading-[1.7] text-[#475569]">
                  Completing a law degree does not automatically qualify graduates to practise as a solicitor or barrister in the UK. Additional training, assessments, and regulatory requirements apply depending on the chosen professional route.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl p-6 sticky top-8">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#64748B] text-center mt-2">
                    Get guidance before selecting a law pathway
                  </p>
                </div>
              </div>
            </div>
